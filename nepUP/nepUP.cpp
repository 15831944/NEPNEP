// nepUP.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_NEPUP, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NEPUP));
...
int update(int argc, _TCHAR* argv[])
{

	//TCHAR ip[30] = _T("218.180.88.59");
	TCHAR ip[30] = _T("127.0.0.1");
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_NEPUP));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_NEPUP);
